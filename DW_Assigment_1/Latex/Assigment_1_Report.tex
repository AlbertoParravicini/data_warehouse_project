...
\subsection{Observations}
The \textit{Dimensional Fact Model} was subsequently converted to a \textit{\textbf{ROLAP}} model. The model was mainly built as a textit{Snowflake} schema, to avoid redundancies and make the relational dependencies look more evident.
